...
INSERT INTO `product` (`id`, `name`, `description`, `price`, `image_url`) VALUES
	...
	(7, 'Xbox Serie X', 'Xbox Series est la gamme de consoles de neuvième génération comprenant la Xbox Series X et la Xbox Series S, développées et fabriquées par Microsoft et sorties le 10 novembre 20202,3. Quatrième génération de consoles Xbox, elles succèdent à la Xbox One. La Xbox Series X est annoncée lors de lE3 2019, tandis que la Xbox Series S est annoncée le 9 septembre 2020.', 499, 'https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RE4mRni?ver=8361');
